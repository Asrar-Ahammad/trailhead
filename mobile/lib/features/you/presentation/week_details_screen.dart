...
class WeekDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('WEEK ${report.weekNumber}, ${report.year}', style: AppTextStyles.retroLabelLarge(color: retroColors.textPrimary)),
        ...
        BarChartData(
          ...
          barTouchData: BarTouchData(
            touchTooltipData: BarTouchTooltipData(
              getTooltipItem: (group, groupIndex, rod, rodIndex) {
                final mins = rod.toY.floor();
                final secs = ((rod.toY - mins) * 60).round();
          ...
          barGroups: List.generate(7, (index) {
            ...
            return BarChartGroupData(
              ...
              barRods: [
                BarChartRodData(
                  toY: stat.avgPace / 60, // convert seconds to fractional minutes
